  ...
  return (
    <div >
      <div className='sm:w-30 w-15 sm:h-auto h-screen border-1 border-gray-300 flex flex-col items-center'>
        ...
        <a href="#">
        <div className='sm:mt-5 mt-8 flex flex-col justify-center items-center gap-2'>
        ...
        <a href="/profile">
        <div className='sm:mt-5 mt-8 mb-7 flex flex-col justify-center items-center gap-2'>
